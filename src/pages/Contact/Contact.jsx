...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    form.append("access_key", "4f31ee6e-44bf-4074-9737-53dbd47f336b"); // ✅ your new key
...
Whether it's a full-time role, freelance project, or just a conversation — feel free to get in touch.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">joshianushka999@gmail.com</p>
                  </div>
                </div>
            ...
            <div className="backdrop-blur-lg bg-white/5 p-8 rounded-2xl shadow-xl">
              ...
              {/* Status Message */}
              {result && (
                <div className={`mt-4 text-center ${result.includes("successfully") ? "text-green-400" : "text-red-400"}`}>
                  <p>{result}</p>
                </div>
              )}
            </div>
